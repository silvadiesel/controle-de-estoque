            ...
            <div className='grid gap-4 max-w-md'>
              {[
                ...
                },
                {
                  ...
                  desc: 'Catálogo organizado por categorias'
                }
              ].map((item, i) => (
                <div
                  key={i}
                  className='flex items-center gap-4 p-4 rounded-xl bg-white/3 border border-white/5 backdrop-blur-sm hover:bg-white/5 transition-colors group'>
