  ...
  return (
    <div className='relative min-h-screen overflow-hidden bg-[#05070b] text-white'>
      ...
      <div className='relative grid min-h-screen lg:grid-cols-[minmax(0,1.35fr)_minmax(420px,0.9fr)]'>
        <section className='relative hidden overflow-hidden border-b border-white/6 lg:block lg:border-r lg:border-b-0'>
          ...
          <div className='relative flex h-full flex-col justify-center gap-20 px-20'>
            <div className='flex items-center gap-4'>
              <div className='flex h-16 w-16 items-center justify-center rounded-[1.25rem] border border-primary/15 bg-white/4 p-3 shadow-[0_18px_45px_rgba(91,127,165,0.16)] backdrop-blur-sm'>
                <Image
            ...
            <div className='max-w-3xl'>
              <p className=' text-6xl font-semibold leading-[0.94] tracking-[-0.06em] text-white '>
                Cresça com controle em cada etapa da{' '}
                <span className='text-primary'>operação.</span>
              </p>

              <p className='mt-6 leading-8 text-zinc-400 sm:text-xl'>
              ...
              <div className='mt-8 grid gap-4 lg:max-w-2xl'>
                {HERO_HIGHLIGHTS.map(({ title, description, icon: Icon }) => (
                  <div
                    key={title}
                    className='flex gap-4 rounded-[1.6rem] border border-white/8 bg-white/3 px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] backdrop-blur-sm sm:px-5'>
          ...
          <div className='relative w-full max-w-[420px] px-6 md:px-0'>
            <div className='mb-10 lg:hidden'>
              <div className='flex items-center gap-3'>
                <div className='flex h-14 w-14 items-center justify-center rounded-[1.1rem] border border-primary/15 bg-white/4 p-3 shadow-[0_16px_32px_rgba(91,127,165,0.14)] backdrop-blur-sm'>
                  <Image
                    src='/img/main_icon.svg'
                    alt='Logo do Igne System'
                    width={36}
              ...
              <p className='mt-6 max-w-sm text-sm leading-6 text-zinc-400 md:flex hidden'>
                {mobileMessage}
              </p>
            </div>
