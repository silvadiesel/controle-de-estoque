...
import { Building2, Bell, Database, Palette, Shield, Download, Tags, Plus, Pencil, Trash2 } from "lucide-react"
import { useStockStore, type Category } from "@/lib/store"

export function Settings() {
  const { products, movements, categories, addCategory, updateCategory, deleteCategory } = useStockStore()
  ...
  const handleDeleteCategory = (id: string) => {
    ...
    if (productsUsingCategory.length > 0) {
      alert(`Não é possível excluir esta categoria. ${productsUsingCategory.length} produto(s) estão usando ela.`)
      return
    }
    deleteCategory(id)
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Personalize o sistema conforme sua necessidade</p>
      </div>
      ...
      <div className="grid gap-6">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Gerencie as categorias disponíveis para os produtos</CardDescription>
              </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-border hover:bg-transparent">
                    ...
                    <TableHead className="text-muted-foreground text-center">Produtos</TableHead>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="company" defaultValue="Oficina de Caminhões Silva" className="bg-input border-border" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="cnpj">CNPJ</Label>
                <Input id="cnpj" defaultValue="12.345.678/0001-90" className="bg-input border-border" />
              </div>
            </div>
            <div className="space-y-2">
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-foreground">Alerta de estoque zerado</p>
                <p className="text-sm text-muted-foreground">Notificação urgente quando o estoque zerar</p>
              </div>
              <Switch defaultChecked />
            </div>
            <Separator className="bg-border" />
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Receber resumo das movimentações toda semana</p>
              </div>
              <Switch />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Baixar backup completo em formato JSON</p>
              </div>
              <Button variant="outline" className="border-border bg-transparent" onClick={handleExportData}>
            ...
            <div className="rounded-lg bg-secondary/50 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Dados salvos localmente</p>
                  <p className="text-sm text-muted-foreground">
                    Seus dados são armazenados no navegador. {products.length} produtos e {movements.length}{" "}
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Visual otimizado para ambientes com pouca luz</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Reduzir espaçamentos para ver mais informações</p>
              </div>
              <Switch />
            </div>
          </CardContent>
